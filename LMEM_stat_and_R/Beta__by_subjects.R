...
p1 <- ggline(means[subject %in% unique(subject)[25]], 'trial_type', interval,
            group = "feedback_cur",
            linetype = "feedback_cur", shape = "feedback_cur",
            color = "feedback_cur", palette = c("#00AFBB", "#E7B800"),
            facet.by =  "subject",
            add = c("mean_se"),
...
ggsave(filename = paste0(out_path,'_Tukey_feedback_cur_1.5_1.9_occip_CH','.png'), width =  6, height = 5)
