...
def create_mne_epochs_evoked(conf, kind, subject, run, CORRECTED_DATA, events_of_interest, plot, raw, picks):
    ...
    #explore reinforcement data with both pos and neg feedback
        if subject == 'P005' and run == '1' or subject == 'P003' and run == '1' or subject == 'P003' and run == '3' or subject == 'P004' and run == '4':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [50, 52, 53], verbose='ERROR')
        elif subject == 'P005' and run == '2' or subject == 'P003' and run == '2':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [50, 53], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [50, 51, 52, 53], verbose='ERROR')
    if kind == 'positive':
    #explore data with positive feedback
        if subject == 'P005' and run == '1' or subject == 'P003' and run == '1' or subject == 'P003' and run == '3' or subject == 'P004' and run == '4':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [50], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [50, 51], verbose='ERROR')
    if kind == 'negative':
    #explore data with negative feedback
        if subject == 'P005' and run == '1' or subject == 'P003' and run == '1' or subject == 'P003' and run == '3' or subject == 'P004' and run == '4':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [52, 53], verbose='ERROR')
        elif subject == 'P005' and run == '2' or subject == 'P003' and run == '2':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [53], verbose='ERROR')
    ...
    if stim == False and kind == 'prerisk':
        if subject == 'P003' and run == '1' or subject == 'P004' and run == '1' or subject == 'P029' and run == '4' or subject == 'P017' and run == '6':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 41, 46], verbose='ERROR')
        elif subject == 'P045' and run == '3' or subject == 'P046' and run == '2' or subject == 'P055' and run == '3' or subject == 'P059' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 41, 47], verbose='ERROR')
        elif  subject == 'P062' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 41, 46], verbose='ERROR')
        elif subject == 'P048' and run == '1' or subject == 'P053' and run == '4': 
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41, 46], verbose='ERROR')
        elif subject == 'P051' and run == '4':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41, 46, 47], verbose='ERROR')
        elif subject == 'P005'and run == '1' or subject == 'P003' and run == '2' or subject == 'P003' and run == '3' or subject == 'P016' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [47], verbose='ERROR')
        elif subject == 'P048'and run == '2':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [47], verbose='ERROR')
        elif subject == 'P059'and run == '1':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [46], verbose='ERROR')
        elif subject == 'P051'and run == '6' or subject == 'P057'and run == '6':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [46, 47], verbose='ERROR')
        elif subject == 'P052'and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 46], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 41], verbose='ERROR')
        elif subject == 'P008' and run == '1' or subject == 'P014' and run == '6' or subject == 'P050' and run == '1' or subject == 'P059' and run == '6':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 46, 47], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41, 47], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [47, 46], verbose='ERROR')
        elif subject == 'P014' and run == '4' or subject == 'P034' and run == '2' or subject == 'P036' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41], verbose='ERROR')
        elif subject == 'P018' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41, 47, 46], verbose='ERROR')
        elif subject == 'P021' and run == '6' or subject == 'P039' and run == '4' or subject == 'P015' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 47], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [40, 41, 46, 47], verbose='ERROR')
    if stim == False and kind == 'risk':
        if subject == 'P003' and run == '1' or subject == 'P009' and run == '1' or subject == 'P021' and run == '1' or subject == 'P008' and run == '2':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [44, 45], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 44, 45], verbose='ERROR')
        elif subject == 'P006' and run == '1' or subject == 'P023' and run == '2' or subject == 'P030' and run == '2' or subject == 'P007' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [45], verbose='ERROR')
        elif subject == 'P008' and run == '1' or subject == 'P025' and run == '1' or subject == 'P011' and run == '2' or subject == 'P015' and run == '2':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [43, 44, 45], verbose='ERROR')
        elif subject == 'P016' and run == '1' or subject == 'P003' and run == '3' or subject == 'P020' and run == '4' or subject == 'P025' and run == '4':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [44], verbose='ERROR')
        elif subject == 'P018' and run == '1' or subject == 'P018' and run == '4' or  subject == 'P053' and run == '1':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 44], verbose='ERROR')
        elif subject == 'P024' and run == '1' or subject == 'P029' and run == '1' or subject == 'P003' and run == '3' or subject == 'P011' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [43, 44], verbose='ERROR')
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [44], verbose='ERROR')
             ...
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [43, 44, 42], verbose='ERROR')
             ...
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [43, 45], verbose='ERROR')
             ...
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 45], verbose='ERROR')
             ...
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 43, 45], verbose='ERROR')
             ...
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 43], verbose='ERROR')
             ...
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 43, 44], verbose='ERROR')
        elif subject == 'P051'and run == '3':
             epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [44], verbose='ERROR')
        elif subject == 'P036' and run == '3':
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [45], verbose='ERROR')
        else:
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 43, 44, 45], verbose='ERROR')
    ...
    if stim == False and kind == 'risk_fb_positive':
        if subject == 'P008' and run == '1' or subject == 'P011' and run == '3' or subject == 'P023' and run == '3' or subject == 'P030' and run == '3':
           epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [43], verbose='ERROR')
        elif subject == 'P014' and run == '6':
           epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42], verbose='ERROR')
        else:
           epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 43], verbose='ERROR')
    ...
    if stim == False and kind == 'fb_negative_norisk':#kind == 'norisk_fb_positive'
        if subject == 'P042' and run == '3':
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [41, 46, 40], verbose='ERROR')
    ...
    if stim == False and kind == 'fb_positive_risk':
        if subject == 'P003' and run == '1' or subject == 'P009' and run == '1' or subject == 'P021' and run == '1' or subject == 'P036' and run == '1':
            ...
            epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [42, 43, 44, 45], verbose='ERROR')
    if stim == True:
        epochs = mne.EpochsArray(CORRECTED_DATA, info=reduced_info, events=events_of_interest, tmin=period_start, baseline=None, event_id= [11], verbose='ERROR')
