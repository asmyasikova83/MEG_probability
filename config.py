...
if Normals:
    subjects_full = ['P001', 'P002', 'P004','P006', 'P007', 'P008', 'P011', 'P014', 'P015', 'P016', 'P017', 'P019',
    ...
    subjects_prerisk_changed_bline = ['P023', 'P053', 'P022','P016',          'P001',        'P055','P060', 'P019', 'P034', 'P004',
...
if Normals_Autists:
    ...
    Normals_prerisk_changed_bline = ['P023', 'P053', 'P022','P016',          'P001',        'P055','P060', 'P019', 'P034', 'P004',
                'P039',              'P047', 'P059',      'P063','P032', 'P044']
    #prerisk changed bline _prerisk_changed_bline
    Autists_prerisk_changed_bline = ['P301','P304','P307','P332',               'P314',     'P318', 'P320', 'P321', 'P322', 'P323',
                        'P325',             'P328', 'P329',     'P334', 'P335', 'P341']
    #risk changed bline 20 subj
